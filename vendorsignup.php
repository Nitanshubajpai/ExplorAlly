    ...
    <body id="vendorsignup">
        ...
        <option value="Pune">Pune</option>
                            ...
                            <div class="form-group col-12">
                                ...
                                <textarea class="form-control" id="address" name="address" rows="4" maxlength="800" spellcheck="false" placeholder="Enter your shop address.">
      </textarea>
                            </div>

                            <div class="form-group col-12">
                                <label for="bio">About your business</label>
                                <textarea class="form-control" id="bio" name="bio" rows="4" maxlength="800" spellcheck="false" placeholder="Wrap it up in 100 words.">
      </textarea>
                            </div>
