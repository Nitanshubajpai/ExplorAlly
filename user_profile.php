...
// CHECK FRIENDS
$is_already_friends = $frnd_obj->is_already_friends($_SESSION['user_id'], $guide_data->id);
//  IF I AM THE REQUEST SENDER
$check_req_sender = $frnd_obj->am_i_the_req_sender($_SESSION['user_id'], $guide_data->id);
// IF I AM THE REQUEST RECEIVER
$check_req_receiver = $frnd_obj->am_i_the_req_receiver($_SESSION['user_id'], $guide_data->id);
// TOTAL REQUESTS
    ...
    <div class="profile_container">
        ...
        <nav>
            ...
            <form action="" method="POST">
                ...
                <?php
                if(isset($_POST['hour']) && $_POST['date']) {
            ...
            <div class="actions">
                ...
                if($is_already_friends){
                    echo '<a href="userfunctions.php?action=unfriend_req&id='.$guide_data->id.'" class="req_actionBtn unfriend">Unfriend</a>';
                }
                elseif($check_req_sender){
                    echo '<a href="userfunctions.php?action=cancel_req&id='.$guide_data->id.'" class="req_actionBtn cancleRequest">Cancel Request</a>';
                }
                elseif($check_req_receiver){
                    ...
                    <a href="userfunctions.php?action=accept_req&id='.$guide_data->id.'" class="req_actionBtn acceptRequest">Accept</a>';
                }
                else{
                    echo '<a href="userfunctions.php?action=send_req&id='.$guide_data->id.'" class="req_actionBtn sendRequest">Send Request</a>';
                }
                ?>
